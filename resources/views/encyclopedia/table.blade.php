					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="{{route('encyclopedia.add')}}" class="btn btn-secondary btn-round">Add</a>
							</div>
						</div>
					</div>
				</div>
					...
					columns: [
						...
						{ data: 'category.name' },
						{
							...
							render: function(data, type, row){
								var url_edit = "{{url('/encyclopedia/edit')}}"+"/"+data;
								return '\
								<a href="'+url_edit+'" class="btn btn-xs btn-warning my-1">Edit</a>\
								<button class="btn btn-xs btn-danger my-1" onclick="deleteEncyclopedia('+data+')">Delete</button>';
							}
						},
					]
				});
